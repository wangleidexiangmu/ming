...
jQuery( document ).ready(function($) {
    ...
    $( document ).on( 'click', '.customize_multi_add_field', kingston_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', kingston_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', kingston_customize_multi_remove_field )
    ...
    function kingston_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            kingston_customize_multi_write( $control );
    }

    function kingston_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        kingston_customize_multi_write( $control );
    }

    function kingston_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function kingston_customize_multi_write( $element) {
