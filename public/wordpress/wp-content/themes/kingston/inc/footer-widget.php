...
class Kingston_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'kingston';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'kingston' ), $i ),
...
// Initialize.
$kingston_footer_widgets = new Kingston_Footer_Widgets();
