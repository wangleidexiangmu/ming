 ...
 */
Class Kingston_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
 ...
 */
Class Kingston_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Kingston_Dropdown_Chosen_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kingston-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 * @see WP_Customize_Control
 */
class Kingston_Icon_Picker_Control extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="kingston-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'kingston' ); ?>" class="kingston-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
 ...
 * @since  1.0.0
 */
class Kingston_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
 ...
 * @see WP_Customize_Control
 */
Class Kingston_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @access public
 */
class Kingston_Customize_Section_Upsell extends WP_Customize_Section {
